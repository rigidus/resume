...
** [[https://github.com/rigidus/rigidus][rigidus.ru]]
*** JavaScript, Common Lisp
Site and blog engine. Contains a number of my articles.
...
*** Common Lisp
An automated job analysis project that builds on my early research on expert systems.
...
from absolute zero in assembler x86. Supports exceptions,
object-oriented programming, system calls, and high-level Forth code
decompilation. Contains a fortho-assembler.
