...
- Have worked with :: Java, Python, C++, Rust, Clojure, Erlang, C#, PHP, Bash
* Projects
...
* Experience
** Core Blockchain Developer at MEP
*** Rust, Solidity, Web3 | Mar2022 - till now
Startup passes the MVB Accelerator program from Binance Lab. MEP is an interoperability communication protocol
My responsibility:
- Design and implementation of a virtual machine for multi-chain event exchange
- Implementation of the multi-chain protocol
...
The company is developing a solution for scaling Ethereum.
My responsibility:
